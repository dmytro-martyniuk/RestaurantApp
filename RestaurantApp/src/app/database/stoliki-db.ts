import { Stolik } from '../classes/Stolik';

export const STOLIKI: Stolik[]= [
    {lokalizacja:{nazwa: 'L1'}, nazwa: 'S1'},
    {lokalizacja:{nazwa: 'L1'}, nazwa: 'S2'},
    ...
    {lokalizacja:{nazwa: 'L4'}, nazwa: 'S1'},
    {lokalizacja:{nazwa: 'L4'}, nazwa: 'S2'},
